...
enum LID_TYPE{AVIA = 1, VELO16, OUSTER, HESAI128, XGRIDS, GAZEBO}; //{1, 2, 3, 4, 5, 6}
...
//   EIGEN_MAKE_ALIGNED_OPERATOR_NEW
  ...
  void hesai128_handler(const sensor_msgs::msg::PointCloud2::SharedPtr &msg);
  void gazebo_handler(const sensor_msgs::msg::PointCloud2::SharedPtr &msg);
